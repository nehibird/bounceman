...
module.exports = defineConfig({
  ...
  testIgnore: ['**/pricing-availability.test.js', '**/addon-pricing.test.js', '**/call-routing.test.js', '**/regression-pre-pr.test.js', '**/sunday-rules.test.js', '**/phone-format.test.js', '**/sarah-noreply.test.js'],
