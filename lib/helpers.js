...
// --- Sunday rentals -------------------------------------------------------------
// We don't pick up on Sunday evenings, so a Sunday rental stays out overnight and is
// collected Monday morning. That is a selling point (the customer keeps it longer) but
// it has to be said out loud in every channel, because "your rental is Sunday" reads as
// "gone Sunday night" unless we correct it.
//
...
const SUNDAY_PICKUP_NOTE =
  'Because your rental falls on a Sunday, we pick up Monday morning instead of Sunday evening — the unit stays with you overnight at no extra charge. Please leave it set up and plugged in overnight if you can, and keep it accessible for our Monday pickup.';
